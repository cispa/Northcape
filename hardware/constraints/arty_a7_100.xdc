...
# Clashes with Vivado-generated constraint
...
set_property CLOCK_DEDICATED_ROUTE TRUE [get_nets sys_clk_i_1]

## Switches
#set_property -dict { PACKAGE_PIN A8 IOSTANDARD LVCMOS33 } [get_ports { sw[0] }]; #IO_L13N_T2_MRCC_16 Sch=sw[0]
#set_property -dict { PACKAGE_PIN C11 IOSTANDARD LVCMOS33 } [get_ports { sw[1] }]; #IO_L14P_T2_SRCC_16 Sch=sw[1]
...
## Pmod Header JA - SD / MicroSD Pmod or CAN
## Pin 1 is SS
## Pin 2 is MOSI
## Pin 3 is MISO
## Pin 4 is CLK
...
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { can_int }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
# not connected - conflict with MicroSD Pmod
# set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { can_rst }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { can_rx0bf }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { can_rx1bf }]; #IO_25_15 Sch=ja[10]


## Pmod Header JB / JTAG
# set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { jtag_tms }]; #IO_L12P_T1_MRCC_15 Sch=jb[0]
# set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { jtag_tdi }]; #IO_L12N_T1_MRCC_15 Sch=jb[1]
# set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { jtag_tdo }]; #IO_L22N_T3_A16_15 Sch=jb[2]
# set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { jtag_tck }]; #IO_L23P_T3_FOE_B_15 Sch=jb[3]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { jtag_trst_n }]; #IO_L23N_T3_FWE_B_15 Sch=jb[6]
# other pins not used
...
## Pmod Header JC / TPM
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { tpm_spi_cs_n }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { tpm_spi_mosi }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { tpm_spi_miso }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { tpm_spi_sclk }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { tpm_spi_rst }]; #IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
...
## Pmod Header JD / JTAG
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { jtag_tms }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
...
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { jtag_tck }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
# other pins not used
# set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { jd[4] }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
# set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { jd[5] }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
# set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { jd[6] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
# set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { jtag_trst_n }]; #IO_L15N_T2_DQS_35 Sch=jd[10]
...
# delay constraints from CVA6 project
...
# TRNG
# OOC synthesis
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets SoC_i/northcape_northbridge/northcape_cap_ops_wr_0/inst/i_northcape_cap_ops_wrapper/i_rng/i_trng/ro_out*]
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets SoC_i/northcape_northbridge/northcape_cap_ops_wr_0/inst/i_northcape_cap_ops_wrapper/i_rng/ro_out*]
# Global synthesis
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets SoC_i/SoC_i/northcape_northbridge/northcape_cap_ops_wr_0/inst/i_northcape_cap_ops_wrapper/i_rng/ro_out*]

# 2FF
set_property ASYNC_REG TRUE [get_cells SoC_i/xilinx_peripherals/interrupt_sync_fast_0/inst/*reg]
set_max_delay -datapath_only -from [get_cells SoC_i/xilinx_peripherals/interrupt_sync_fast_0/inst/irq_q1_reg] -to [get_cells SoC_i/xilinx_peripherals/interrupt_sync_fast_0/inst/irq_q2_reg] 10.000
set_max_delay -datapath_only -from [get_cells SoC_i/xilinx_peripherals/interrupt_sync_fast_0/inst/irq_q4_reg] -to [get_cells SoC_i/xilinx_peripherals/interrupt_sync_fast_0/inst/irq_q1_reg] 10.000

# SPI TPM
create_clock -period 160.000 -name VIRTUAL_clk_12_5_SoC_peripherals_clockgen_0 -waveform {0.000 80.000}
set_input_delay -clock [get_clocks {VIRTUAL_clk_12_5_SoC_peripherals_clockgen_0 }] -clock_fall -min -add_delay 0.0 [get_ports {tpm_miso_i}]
set_input_delay -clock [get_clocks {VIRTUAL_clk_12_5_SoC_peripherals_clockgen_0 }] -clock_fall -max -add_delay 13.0 [get_ports {tpm_miso_i}]

set_output_delay -clock [get_clocks {VIRTUAL_clk_12_5_SoC_peripherals_clockgen_0 }] -min -add_delay -5.0 [get_ports {tpm_mosi_o}]
set_output_delay -clock [get_clocks {VIRTUAL_clk_12_5_SoC_peripherals_clockgen_0 }] -max -add_delay 5.0 [get_ports {tpm_mosi_o}]



# Clock Groups
set_clock_groups -asynchronous -group [get_clocks jtag_clk] -group [get_clocks clk_25_SoC_sys_pll_0]
set_clock_groups -asynchronous -group [get_clocks clk_25_SoC_sys_pll_0] -group [get_clocks jtag_clk]
