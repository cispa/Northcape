...
## Buttons - CAREFUL! Depends on VADJ setting (3.3V for NorthernLights)
#set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { btnc }]; #IO_25_17 Sch=btnc
#set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { btnd }]; #IO_0_15 Sch=btnd
#set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { btnl }]; #IO_L6P_T0_15 Sch=btnl
#set_property -dict { PACKAGE_PIN C19   IOSTANDARD LVCMOS33 } [get_ports { btnr }]; #IO_L24P_T3_17 Sch=btnr
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { btnu }]; #IO_L24N_T3_17 Sch=btnu
...
## Switches - CAREFUL! Depends on VADJ setting (3.3V for NorthernLights)
#set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { sw[0] }]; #IO_0_17 Sch=sw[0]
#set_property -dict { PACKAGE_PIN G25   IOSTANDARD LVCMOS33 } [get_ports { sw[1] }]; #IO_25_16 Sch=sw[1]
#set_property -dict { PACKAGE_PIN H24   IOSTANDARD LVCMOS33 } [get_ports { sw[2] }]; #IO_L19P_T3_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { sw[3] }]; #IO_L6P_T0_17 Sch=sw[3]
#set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS33 } [get_ports { sw[4] }]; #IO_L19P_T3_A22_15 Sch=sw[4]
#set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports { sw[5] }]; #IO_25_15 Sch=sw[5]
...
## PMOD Header JA - TPM SPI
# set_property -dict { PACKAGE_PIN U27   IOSTANDARD LVCMOS33 } [get_ports { tpm_cs_no }]; #IO_L13P_T2_MRCC_14 Sch=ja_p[1]
# set_property -dict { PACKAGE_PIN U28   IOSTANDARD LVCMOS33 } [get_ports { tpm_mosi_o }]; #IO_L13N_T2_MRCC_14 Sch=ja_n[1]
# set_property -dict { PACKAGE_PIN T26   IOSTANDARD LVCMOS33 } [get_ports { tpm_miso_i }]; #IO_L12P_T1_MRCC_14 Sch=ja_p[2]
# set_property -dict { PACKAGE_PIN T27   IOSTANDARD LVCMOS33 } [get_ports { tpm_sclk_o }]; #IO_L12N_T1_MRCC_14 Sch=ja_n[2]
# set_property -dict { PACKAGE_PIN T22   IOSTANDARD LVCMOS33 } [get_ports { tpm_rst_no }]; #IO_L5P_T0_D06_14 Sch=ja_p[3]
...
## PMOD Header JB
set_property -dict { PACKAGE_PIN V29   IOSTANDARD LVCMOS33 } [get_ports { tpm_cs_no }]; #IO_L17P_T2_A14_D30_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V30   IOSTANDARD LVCMOS33 } [get_ports { tpm_mosi_o }]; #IO_L17N_T2_A13_D29_14 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN V25   IOSTANDARD LVCMOS33 } [get_ports { tpm_miso_i }]; #IO_L18P_T2_A12_D28_14 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W26   IOSTANDARD LVCMOS33 } [get_ports { tpm_sclk_o }]; #IO_L18N_T2_A11_D27_14 Sch=jb_n[2]
set_property -dict { PACKAGE_PIN T25   IOSTANDARD LVCMOS33 } [get_ports { tpm_rst_no }]; #IO_L14P_T2_SRCC_14 Sch=jb_p[3]
...
## PMOD Header JC
#set_property -dict { PACKAGE_PIN AC26  IOSTANDARD LVCMOS33 } [get_ports { tpm_cs_no }]; #IO_L19P_T3_13 Sch=jc[1]
#set_property -dict { PACKAGE_PIN AJ27  IOSTANDARD LVCMOS33 } [get_ports { tpm_mosi_o }]; #IO_L20P_T3_13 Sch=jc[2]
#set_property -dict { PACKAGE_PIN AH30  IOSTANDARD LVCMOS33 } [get_ports { tpm_miso_i }]; #IO_L18N_T2_13 Sch=jc[3]
#set_property -dict { PACKAGE_PIN AK29  IOSTANDARD LVCMOS33 } [get_ports { tpm_sclk_o }]; #IO_L15P_T2_DQS_13 Sch=jc[4]
#set_property -dict { PACKAGE_PIN AD26  IOSTANDARD LVCMOS33 } [get_ports { tpm_rst_no }]; #IO_L19N_T3_VREF_13 Sch=jc[7]
...
## XADC Header - CAREFUL! Depends on VADJ setting (3.3V for NorthernLights)
...
# TRNG
# OOC synthesis
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets SoC_i/northcape_northbridge/northcape_caps/northcape_cap_ops/inst/i_northcape_cap_ops_wrapper/i_rng/i_trng/ro_out*]
# Global synthesis
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets SoC_i/northcape_northbridge/northcape_caps/northcape_cap_ops/inst/i_northcape_cap_ops_wrapper/i_rng/ro_out*]

# SPI TPM
create_clock -period 640.000 -name VIRTUAL_spi_clk -waveform {0.000 320.000}
set_input_delay -clock [get_clocks {VIRTUAL_spi_clk}] -clock_fall -min -add_delay 0.0 [get_ports {tpm_miso_i}]
set_input_delay -clock [get_clocks {VIRTUAL_spi_clk}] -clock_fall -max -add_delay 13.0 [get_ports {tpm_miso_i}]

set_output_delay -clock [get_clocks {VIRTUAL_spi_clk}] -min -add_delay -5.0 [get_ports {tpm_mosi_o}]
set_output_delay -clock [get_clocks {VIRTUAL_spi_clk}] -max -add_delay 5.0 [get_ports {tpm_mosi_o}]
