...
module rvfi_tracer #(
  ...
  initial begin
    ...
    if (TOHOST_ADDR == '0) begin
        ...
        $display("*** [rvf_tracer] INFO: SIM_FINISH: %d", SIM_FINISH);
        if (TOHOST_ADDR == '0) begin
  ...
  always_comb begin
    pc64 = '0;
    cause = "";
    end_of_test_n = (rst_ni && (end_of_test_q[0] == 1'b1)) ? end_of_test_q : 0;
        ...
        if ( rvfi_i[i].insn[6:0] == 7'b1001111 ||
          ...
          if (rvfi_i[i].mem_wmask != 0) begin
            ...
            if (TOHOST_ADDR != '0 &&
              ...
              end_of_test_n = rvfi_i[i].mem_wdata[31:0];
            end
          end
        end
        $fwrite(f, "\n");
