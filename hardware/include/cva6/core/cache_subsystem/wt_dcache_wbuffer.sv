...
#(
    ...
    output northcape_types::task_id_t miss_task_id_o,
  ...
  assign miss_irq_o = wbuffer_dirty_mux.is_irq;
  assign miss_task_id_o = wbuffer_dirty_mux.task_id;
  assign miss_device_interpreted_restriction_o = wbuffer_dirty_mux.device_interpreted_restriction;
  ...
  assign req_port_o.data_rerror = 1'b0;
  ...
  always_comb begin : p_buffer
    ...
    if (req_port_i.data_req && rdy) begin
      ...
      if (!ni_conflict) begin  //empty of NI operations
        ...
        wbuffer_d[wr_ptr].is_irq = req_port_i.is_irq;
        wbuffer_d[wr_ptr].task_id = req_port_i.task_id;
        wbuffer_d[wr_ptr].device_interpreted_restriction = req_port_i.device_interpreted_restriction;
        // mark bytes as dirty
        for (int k = 0; k < (CVA6Cfg.XLEN / 8); k++) begin
