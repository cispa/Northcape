...
`endif
    ...
    // Northcape stall cycle - PERF_COUNTERS
    ...
    // Data cache flush + full invalidate - NORTHCAPE OPS
...
`endif
  ...
  function automatic hpdcache_pkg::hpdcache_user_cfg_t hpdcacheSetConfig();
    ...
    userCfg.wbEn =
        ...
        (CVA6Cfg.DCacheType == config_pkg::HPDCACHE_WT_WB);
    userCfg.axiUserWidth = CVA6Cfg.ArAwUserWidth;
    return userCfg;
  endfunction
...
`endif
      ...
      .dcache_flush_inval_all_i(dcache_flush_inval_all_i),
