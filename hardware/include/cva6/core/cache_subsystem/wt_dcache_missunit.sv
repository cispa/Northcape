...
#(
    ...
    input logic [NumPorts-1:0] miss_irq_i,
    input northcape_types::task_id_t [NumPorts-1:0] miss_task_id_i,
    input northcape_types::northcape_device_interpreted_restriction_t [NumPorts-1:0] miss_device_interpreted_restriction_i,
    ...
    output logic wr_cl_data_error_o,
  ...
  assign mem_data_o.is_irq = (CVA6Cfg.RVA && amo_sel) ? amo_req_i.is_irq : miss_irq_i[miss_port_idx];
  assign mem_data_o.task_id = (CVA6Cfg.RVA && amo_sel) ? amo_req_i.task_id : miss_task_id_i[miss_port_idx];
  assign mem_data_o.device_interpreted_restriction = (CVA6Cfg.RVA && amo_sel) ? amo_req_i.device_interpreted_restriction : miss_device_interpreted_restriction_i[miss_port_idx];
  ...
  assign wr_cl_data_error_o = mem_rtrn_i.bus_error;
