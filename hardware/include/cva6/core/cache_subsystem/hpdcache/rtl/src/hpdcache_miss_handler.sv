...
(
    ...
    input  logic [HPDcacheCfg.axiUserWidth-1:0] mshr_alloc_user_i,
...
//  }}}
    ...
    logic [HPDcacheCfg.axiUserWidth-1:0] mshr_alloc_user_q;
    ...
    assign mem_req_o.mem_req_user = mshr_alloc_user_q;
    ...
    begin : miss_req_fsm_internal_ff
        if (mshr_alloc) begin
            ...
            mshr_alloc_user_q <= mshr_alloc_user_i;
        end
    end
