...
(
    ...
    input  logic [HPDcacheCfg.axiUserWidth-1:0] write_user_i, // axi user
    ...
    typedef struct packed {
        ...
        wbuf_tag_t      tag;
        logic           uc;
        logic [HPDcacheCfg.axiUserWidth - 1 : 0] user;
    } wbuf_dir_entry_t;
            ...
            unique case (wbuf_dir_state_q[i])
                WBUF_FREE: begin
                    ...
                    if (write_i && match_free) begin
                        ...
                        wbuf_dir_d[i].user = write_user_i;
    ...
    for (genvar i = 0; i < WBUF_DIR_NENTRIES; i++) begin : gen_wbuf_dir_pend
        ...
        assign wbuf_meta_pend[i].meta_user = wbuf_dir_q[i].user;
    ...
    assign mem_req_write_o.mem_req_user = { wbuf_meta_send_q.meta_user};
