...
`endif
    ...
    logic [HPDcacheCfg.axiUserWidth-1:0] miss_mshr_alloc_user;
    ...
    logic [HPDcacheCfg.axiUserWidth-1:0] wbuf_write_user;
    logic                  wbuf_read_hit;
    ...
    logic [HPDcacheCfg.axiUserWidth-1:0] uc_req_user;
    ...
    logic [HPDcacheCfg.axiUserWidth-1:0] flush_alloc_user;
    ...
    hpdcache_ctrl #(
        ...
        .st2_mshr_alloc_user_o              (miss_mshr_alloc_user),
    ...
    hpdcache_miss_handler #(
        ...
        .mshr_alloc_user_i                  (miss_mshr_alloc_user),
    ...
    if (HPDcacheCfg.u.wbEn) begin : gen_flush
        ...
        // cache -> memory: cannot go to MMIO device, so no need
        assign flush_alloc_user = '0;
        ...
        hpdcache_flush #(
            ...
            .flush_alloc_user_i            (flush_alloc_user),
