...
(
    ...
    input logic [HPDcacheCfg.axiUserWidth-1:0] req_user_i,
...
//  {{{
    ...
    logic [HPDcacheCfg.axiUserWidth-1:0] req_user_q;
...
//  {{{
    ...
    begin : mem_req_read_comb
        ...
        mem_req_read_o.mem_req_user      = req_user_q;
...
//  {{{
    ...
    begin : mem_req_write_comb
        ...
        mem_req_write_o.mem_req_user      = req_user_q;
