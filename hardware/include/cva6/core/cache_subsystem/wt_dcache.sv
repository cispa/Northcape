...
#(
  ...
  logic     [                      NumPorts-1:0]                                  miss_irq;
  logic     [         CVA6Cfg.MEM_TID_WIDTH-1:0]                                  miss_rtrn_id;
  northcape_types::task_id_t  [                      NumPorts-1:0]                miss_task_id;
  northcape_types::northcape_device_interpreted_restriction_t [     NumPorts-1:0] miss_device_interpreted_restriction;
  ...
  wt_dcache_missunit #(
      ...
      .miss_irq_i             (miss_irq),
      .miss_task_id_i         (miss_task_id),
      .miss_device_interpreted_restriction_i(miss_device_interpreted_restriction),
      ...
      .wr_cl_data_error_o     (wr_cl_data_error),
  ...
  for (genvar k = 0; k < NumPorts - 1; k++) begin : gen_rd_ports
    ...
    if ((k == 0 && CVA6Cfg.MmuPresent) || (k == 1) || (k == 2 && (CVA6Cfg.EnableAccelerator || CVA6Cfg.SUPPORT_NON_STANDARD_TABLE_ISR_MODE))) begin
      ...
      wt_dcache_ctrl #(
          ...
          .miss_irq_o     (miss_irq[k]),
          .miss_task_id_o (miss_task_id[k]),
          .miss_device_interpreted_restriction_o(miss_device_interpreted_restriction[k]),
      ...
      assign miss_irq[k] = 1'b0;
      assign miss_task_id[k] = '0;
      assign miss_device_interpreted_restriction[k] = '0;
  ...
  wt_dcache_wbuffer #(
      ...
      .miss_irq_o     (miss_irq[NumPorts-1]),
      .miss_task_id_o (miss_task_id[NumPorts-1]),
      .miss_device_interpreted_restriction_o(miss_device_interpreted_restriction[NumPorts-1]),
  ...
  wt_dcache_mem #(
      ...
      .wr_cl_data_error_i     (wr_cl_data_error),
