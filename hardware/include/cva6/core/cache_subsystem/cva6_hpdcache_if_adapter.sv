...
(
    ...
    input  logic cva6_dcache_flush_inval_all_i,
  ...
  northcape_types::northcape_axi_user_t northcape_axi_user;
  ...
  generate
      ...
      begin: gen_axi_user
        assign northcape_axi_user.current_device_id = (CVA6Cfg.NORTHCAPE_MMU_INSTR_DEVICE_ID) >> 1;
        assign northcape_axi_user.device_interpreted_restriction = cva6_req_i.device_interpreted_restriction;
        assign northcape_axi_user.current_task_id = cva6_req_i.task_id;
      end: gen_axi_user
      else
      begin: gen_no_axi_user
        assign northcape_axi_user = '0;
      end: gen_no_axi_user
    endgenerate
  //  }}}
  ...
  generate
    ...
    if (IsLoadPort == 1'b1) begin : load_port_gen
      ...
      ) || (CVA6Cfg.NORTHCAPE_STAGE_ENABLED == 1'b1 && cva6_req_i.is_non_cacheable);
      ...
      assign hpdcache_req.user = northcape_axi_user;
      ...
      assign hpdcache_req_flush = '{
              ...
              wdata: '0,
              op:
              (InvalidateOnFlush || cva6_dcache_flush_inval_all_i)
              ?
