...
#(
    ...
    output logic northcape_delay_o, // to performance counter
    // ICache flush done - CONTROLLER
  ...
  logic         [  CVA6Cfg.ArAwUserWidth-1:0] axi_aruser_out;
  logic                                    axi_rd_exokay;
  ...
  assign icache_mem_rtrn.rd_bus_error = axi_rd_error;

  generate
    if(CVA6Cfg.AXI_USER_DISCRIMINATE_INSTR_DATA_FETCH)
    begin: indicateFetchViaUser
      assign axi_aruser_out = 1;
    end: indicateFetchViaUser
    else
    begin: setUserNull
      assign axi_aruser_out = '0;
    end: setUserNull
  endgenerate
  ...
  cva6_icache #(
      ...
      .en_i          (en_i),
      .miss_o        (miss_o),
      .northcape_delay_o(northcape_delay_o),
  ...
  axi_shim #(
      ...
      .wr_exokay_o        (),
      .wr_bus_error_o     (),
      .ar_user_i(axi_aruser_out),
      .aw_user_i('0), // never writes
      .axi_req_o  (axi_req_o),
