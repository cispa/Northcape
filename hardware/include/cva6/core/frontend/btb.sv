...
module btb #(
  ...
  // block RAM does not support flushing the BTP
  // so we need the ASIC implementation in case this needs to be triggered manually
  if (CVA6Cfg.FpgaEn && !CVA6Cfg.EnableCSRFlushBTP) begin : gen_fpga_btb  //FPGA TARGETS
