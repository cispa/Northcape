...
#(
    ...
    input logic is_irq_i, // is in IRQ context?
  ...
  struct packed {
    ...
    northcape_types::task_id_t              lsu_current_task; // current northcape task
    northcape_types::northcape_device_interpreted_restriction_t lsu_device_restriction; // current device restriction
  }
  ...
  always_comb begin : core_if
    ...
    if (valid_i) begin
      ...
      speculative_queue_n[speculative_write_pointer_q].is_irq = is_irq_i;
      speculative_queue_n[speculative_write_pointer_q].lsu_current_task = lsu_current_task_i;
      speculative_queue_n[speculative_write_pointer_q].is_non_cacheable = lsu_is_non_cacheable_i;
      ...
      speculative_queue_n[speculative_write_pointer_q].lsu_device_restriction = lsu_device_restriction_i;
  ...
  assign req_port_o.is_irq = commit_queue_q[commit_read_pointer_q].is_irq;
  assign req_port_o.task_id = commit_queue_q[commit_read_pointer_q].lsu_current_task;
  assign req_port_o.is_non_cacheable = commit_queue_q[commit_read_pointer_q].is_non_cacheable;
  assign req_port_o.device_interpreted_restriction = commit_queue_q[commit_read_pointer_q].lsu_device_restriction;
  ...
  always_comb begin : store_if
    ...
    if (commit_queue_q[commit_read_pointer_q].valid && !stall_st_pending_i && !commit_queue_q[commit_read_pointer_q].wait_rvalid) begin
      ...
      begin
        ...
        else if(commit_queue_q[commit_read_pointer_q].cbo_op != ariane_pkg::CBO_NONE && req_port_i.data_gnt)
        begin
