...
module axi_shim #(
    ...
    output logic rd_bus_error_o, // indicates whether read caused any errors
    // write channel
    ...
    output logic wr_bus_error_o, // indicates whether write caused any errors
    output logic [CVA6Cfg.AxiIdWidth-1:0] wr_id_o,
    output logic wr_exokay_o,  // indicates whether exclusive tx succeeded
    input logic [CVA6Cfg.ArAwUserWidth-1:0] ar_user_i,
    input logic [CVA6Cfg.ArAwUserWidth-1:0] aw_user_i,
    // AXI port
  ...
  assign axi_req_o.aw.user = aw_user_i;
  ...
  assign wr_bus_error_o = !(axi_resp_i.b.resp inside {axi_pkg::RESP_EXOKAY, axi_pkg::RESP_OKAY});
  ...
  assign axi_req_o.ar.user   = ar_user_i;
  ...
  assign rd_bus_error_o = !(axi_resp_i.r.resp inside {axi_pkg::RESP_EXOKAY, axi_pkg::RESP_OKAY});
