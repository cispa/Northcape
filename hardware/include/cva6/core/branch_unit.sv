...
module branch_unit #(
  ...
  always_comb begin : mispredict_handler
    ...
    resolved_branch_o.task_id = fu_data_i.task_id;
    ...
    // SCALL ID: need to forward the result to the commit stage
    if(CVA6Cfg.NORTHCAPE_SCALL_EXTENSION && fu_data_i.operation == ariane_pkg::JALR && fu_data_i.is_scall_id)
    begin
      branch_result_o = fu_data_i.operand_b;
      // this is R-type; immediate is meaningless
      target_address = jump_base;
