...
```sh
    mmc info; fatload mmc 0:2 90000000 uImage; setenv fdt_high xffffffffffffffff; bootm 90000000 - $(fdtcontroladdr) # for larger Genesys2 board
    mmc info; fatload mmc 0:2 8a000000 uImage; setenv fdt_high xffffffffffffffff; bootm 8a000000 - $(fdtcontroladdr) # for smaller ARTY A7 board
```
