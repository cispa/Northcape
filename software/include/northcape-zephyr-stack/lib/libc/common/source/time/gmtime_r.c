...
/* definitions from toolchain etc. */
...
#ifdef CONFIG_SKADI_OS
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_NOIRQ(struct tm *, __skadi_gmtime_r, const time_t *ZRESTRICT timep, struct tm *ZRESTRICT result);
	return gmtime_r(timep, result);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_gmtime_r)
#endif
