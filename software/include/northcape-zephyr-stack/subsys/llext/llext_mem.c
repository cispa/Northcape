...
/* Declared BEFORE LOG_MODULE_DECLARE to avoid shadow warning */
			      ...
			      enum llext_mem mem_idx)
{
	 ...
	 */
#ifdef CONFIG_SKADI_OS
	const uintptr_t sect_alloc = ldr->sects[mem_idx].sh_size;
...
#ifdef CONFIG_SKADI_OS
	ext->mem[mem_idx] = skadi_init_alloc_allocate_section(sect_alloc, mem_idx);
#else
