...
#ifdef CONFIG_SKADI_OS
	/* static initialization currently not supported */
	static bool fs_init_mutex(void){
		return skadi_mutex_init(&mutex) == 0;
	}
	SKADI_SUBSYSTEM_INIT_FUNCTIONS(fs_init_mutex);
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_open, struct fs_file_t *zfp, const char *file_name, fs_mode_t flags)
		return fs_open(zfp, file_name, flags);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_open)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_close, struct fs_file_t *zfp)
		return fs_close(zfp);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_close)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(ssize_t, __skadi_fs_read, struct fs_file_t *zfp, void *ptr, size_t size)
		return fs_read(zfp, ptr, size);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_read)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(ssize_t, __skadi_fs_write, struct fs_file_t *zfp, const void *ptr, size_t size)
		return fs_write(zfp, ptr, size);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_write)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_seek, struct fs_file_t *zfp, off_t offset, int whence)
		return fs_seek(zfp, offset, whence);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_seek)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(off_t, __skadi_fs_tell, struct fs_file_t *zfp)
			return fs_tell(zfp);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_tell)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_truncate, struct fs_file_t *zfp, off_t length)
		return fs_truncate(zfp, length);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_truncate)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_sync, struct fs_file_t *zfp)
		return fs_sync(zfp);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_sync)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_opendir, struct fs_dir_t *zdp, const char *abs_path)
		return fs_opendir(zdp, abs_path);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_opendir)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_readdir, struct fs_dir_t *zdp, struct fs_dirent *entry)
		return fs_readdir(zdp, entry);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_readdir)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_closedir, struct fs_dir_t *zdp);
		return fs_closedir(zdp);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_closedir)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_mkdir, const char *abs_path)
		return fs_mkdir(abs_path);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_mkdir)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_unlink, const char *abs_path)
		return fs_unlink(abs_path);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_unlink)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_rename, const char *from, const char *to)
		return fs_rename(from, to);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_rename)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_stat, const char *abs_path, struct fs_dirent *entry)
		return fs_stat(abs_path, entry);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_stat)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_fs_statvfs, const char *abs_path, struct fs_statvfs *stat)
		return fs_statvfs(abs_path, stat);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_fs_statvfs)
#endif
