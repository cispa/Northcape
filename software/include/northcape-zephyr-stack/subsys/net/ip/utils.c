...
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(char *, __skadi_zsock_inet_ntop, sa_family_t family, const void *src, char *dst, size_t size)
	/* retval is dst, which is a writable buffer ... */
	return z_impl_net_addr_ntop(family, src, dst, size);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_zsock_inet_ntop)
#endif
...
#ifdef CONFIG_SKADI_OS
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_net_addr_pton, sa_family_t family, const char *src, void *dst)
	return net_addr_pton(family, src, dst);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_net_addr_pton)
#endif
...
#ifdef CONFIG_SKADI_OS
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(bool, __skadi_net_ipaddr_parse, const char *str, size_t str_len, struct sockaddr *addr)
	return net_ipaddr_parse(str, str_len, addr);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_net_ipaddr_parse)
#endif
