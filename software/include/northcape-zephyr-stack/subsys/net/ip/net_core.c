...
#ifdef CONFIG_SKADI_OS
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_NOIRQ(int, skadi_net_recv_data, struct net_if *iface, struct net_pkt *pkt)
	return net_recv_data(iface->net_if_or, pkt);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(skadi_net_recv_data);
#endif
