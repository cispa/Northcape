...
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_net_ipv4_igmp_join, struct net_if *iface, const struct in_addr *addr, const struct igmp_param *param)
	return net_ipv4_igmp_join(iface, addr, param);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_net_ipv4_igmp_join)
#endif
...
#ifdef CONFIG_SKADI_OS
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_net_ipv4_igmp_leave, struct net_if *iface, const struct in_addr *addr)
	return net_ipv4_igmp_leave(iface, addr);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_net_ipv4_igmp_leave)
#endif
