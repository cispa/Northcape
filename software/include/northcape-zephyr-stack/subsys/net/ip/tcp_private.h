...
#define tcp_malloc(_size) skadi_allocator_alloc_rw(_size)
#define tcp_calloc(_nmemb, _size) skadi_allocator_calloc_rw(_nmemb * _size)
#define tcp_free(_ptr) skadi_allocator_free(_ptr)
#else
