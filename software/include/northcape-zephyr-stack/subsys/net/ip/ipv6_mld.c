...
int net_ipv6_mld_join(struct net_if *iface, const struct in6_addr *addr)
{
	...
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_net_ipv6_mld_join, struct net_if *iface, const struct in6_addr *addr)
		return net_ipv6_mld_join(iface, addr);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_net_ipv6_mld_join)
#endif
...
#ifdef CONFIG_SKADI_OS
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_net_ipv6_mld_leave, struct net_if *iface, const struct in6_addr *addr)
		return net_ipv6_mld_leave(iface, addr);
	SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_net_ipv6_mld_leave)
#endif
