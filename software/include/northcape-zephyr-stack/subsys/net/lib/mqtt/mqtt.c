...
SKADI_SUBSYSTEM_CALLER_TRAMPOLINE_FN_PTR_VOID_ARGS(__skadi_mqtt_evt_cb_wrapper, struct mqtt_client *client, const struct mqtt_evt *evt);
#endif
...
void event_notify(struct mqtt_client *client, const struct mqtt_evt *evt)
{
	if (client->evt_cb != NULL) {
#ifdef SKADI_SUBSYSTEM
		mqtt_evt_cb_t callback = client->evt_cb;
		const struct mqtt_evt *evt_token = skadi_cap_ops_derive_arg_ro(evt, sizeof(*evt));
		__ASSERT_NO_MSG(evt_token);
		if(!evt_token){
			return;
		}
#endif
		...
		__skadi_mqtt_evt_cb_wrapper(client, evt_token, callback);
		(void)skadi_cap_ops_drop(evt_token);
#else
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(void, __skadi_mqtt_client_init, struct mqtt_client *client);
	mqtt_client_init(client);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_client_init)
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_connect, struct mqtt_client *client);
	return mqtt_connect(client);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_connect);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_publish, struct mqtt_client *client, const struct mqtt_publish_param *param);
	return mqtt_publish(client, param);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_publish);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_publish_qos1_ack, struct mqtt_client *client, const struct mqtt_puback_param *param);
	return mqtt_publish_qos1_ack(client, param);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_publish_qos1_ack);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_publish_qos2_receive, struct mqtt_client *client, const struct mqtt_pubrec_param *param);
	return mqtt_publish_qos2_receive(client, param);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_publish_qos2_receive);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_publish_qos2_release, struct mqtt_client *client, const struct mqtt_pubrel_param *param);
	return mqtt_publish_qos2_release(client, param);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_publish_qos2_release);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_publish_qos2_complete, struct mqtt_client *client, const struct mqtt_pubcomp_param *param);
	return mqtt_publish_qos2_complete(client, param);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_publish_qos2_complete);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_disconnect, struct mqtt_client *client);
	return mqtt_disconnect(client);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_disconnect);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_ping, struct mqtt_client *client);
	return mqtt_ping(client);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_ping);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_abort, struct mqtt_client *client);
	return mqtt_abort(client);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_abort);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_live, struct mqtt_client *client);
	return mqtt_live(client);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_live);
#endif
...
#ifdef SKADI_SUBSYSTEM
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_mqtt_input, struct mqtt_client *client);
	return mqtt_input(client);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_mqtt_input);
#endif
