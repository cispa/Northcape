...
Exception on read error example
###########

Overview
********

A sample for the cva6 simulator or the real FPGA. Reads an invalid capability, causing a bus error and expecting an exception.
...
.. code-block:: console
   west build -p always -b cv64a6_testbench samples/boards/openhwgroup/cv64a6/read_error_exception/
