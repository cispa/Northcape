...
static inline void *sys_hashmap_skadi_allocator(void *ptr, size_t size){
	void *ret;
	ret = skadi_allocator_realloc(ptr, size);
	return ret;
}
#define SYS_HASHMAP_DEFAULT_ALLOCATOR sys_hashmap_skadi_allocator
#else
