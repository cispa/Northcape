...
/** zsock_recv: return the next message as zero-copy */
#define ZSOCK_MSG_ZEROCOPY 0x200
/** @} */
...
/* zero-copy-related socket options */
#define SO_ZEROCOPY 99
#define SO_ZEROCOPY_RX_CALLBACK 100
#define SO_ZEROCOPY_TX_CALLBACK 101

/* txtime-related socket options */
#define SO_LAST_TXTIME 102
