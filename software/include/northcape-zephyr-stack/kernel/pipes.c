...
#ifdef CONFIG_SKADI_LOADER
SKADI_INTERFACE_WRAPPER_INIT_GLOBAL(SKADI_PIPE);
#define INIT_FN(PIPE) k_pipe_init(PIPE, buffer, size)
#define FREE_FN(PIPE) (void)(PIPE);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(void, __skadi_pipe_init, struct k_pipe *pipe, unsigned char *buffer, size_t size)
	SKADI_INTERFACE_WRAPPER_REGISTER(SKADI_PIPE, struct k_pipe, INIT_FN, FREE_FN, pipe);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_init)
#endif
...
#ifdef CONFIG_SKADI_LOADER
#define INIT_FN_ALLOC(PIPE) ret = k_pipe_alloc_init(PIPE, size)
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_pipe_alloc_init, struct k_pipe *pipe, size_t size)
	int ret;

	SKADI_INTERFACE_WRAPPER_REGISTER(SKADI_PIPE, struct k_pipe, INIT_FN_ALLOC, FREE_FN, pipe);

	return ret;
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_alloc_init)
#endif
...
#ifdef CONFIG_SKADI_LOADER
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(void, __skadi_pipe_flush, struct k_pipe *pipe)
	return k_pipe_flush(SKADI_INTERFACE_WRAPPER_TRANSLATE(SKADI_PIPE, struct k_pipe, pipe));
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_flush)
#endif
...
#ifdef CONFIG_SKADI_LOADER
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(void, __skadi_pipe_buffer_flush, struct k_pipe *pipe)
	k_pipe_buffer_flush(SKADI_INTERFACE_WRAPPER_TRANSLATE(SKADI_PIPE, struct k_pipe, pipe));
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_buffer_flush)
#endif
...
#ifdef CONFIG_SKADI_LOADER
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_pipe_cleanup, struct k_pipe *pipe)
	int ret = k_pipe_cleanup(SKADI_INTERFACE_WRAPPER_TRANSLATE(SKADI_PIPE, struct k_pipe, pipe));
	SKADI_INTERFACE_WRAPPER_REMOVE(SKADI_PIPE, pipe);
	return ret;
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_cleanup)
#endif
...
#ifdef CONFIG_SKADI_LOADER
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_pipe_put, struct k_pipe *pipe, const void *data, size_t bytes_to_write, size_t *bytes_written, size_t min_xfer, k_timeout_t timeout)
	return k_pipe_put(SKADI_INTERFACE_WRAPPER_TRANSLATE(SKADI_PIPE, struct k_pipe, pipe), data, bytes_to_write, bytes_written, min_xfer, timeout);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_put)
#endif
...
#ifdef CONFIG_SKADI_LOADER
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(int, __skadi_pipe_get, struct k_pipe *pipe, void *data, size_t bytes_to_read, size_t *bytes_read, size_t min_xfer, k_timeout_t timeout)
	return k_pipe_get(SKADI_INTERFACE_WRAPPER_TRANSLATE(SKADI_PIPE, struct k_pipe, pipe), data, bytes_to_read, bytes_read, min_xfer, timeout);
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_get)
#endif
...
#ifdef CONFIG_SKADI_LOADER
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(size_t, __skadi_pipe_read_avail, struct k_pipe *pipe)
	return k_pipe_read_avail(SKADI_INTERFACE_WRAPPER_TRANSLATE(SKADI_PIPE, struct k_pipe, pipe));
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_read_avail)
#endif
...
#ifdef CONFIG_SKADI_LOADER
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE(size_t, __skadi_pipe_write_avail, struct k_pipe *pipe)
	return k_pipe_write_avail(SKADI_INTERFACE_WRAPPER_TRANSLATE(SKADI_PIPE, struct k_pipe, pipe));
SKADI_SUBSYSTEM_CALLEE_TRAMPOLINE_END(__skadi_pipe_write_avail)
#endif
...
__boot_func static int pipe_init_trampolines(void){
    bool init_ok = true;

	init_ok &= __skadi_pipe_init_register_init_function();
	init_ok &= __skadi_pipe_cleanup_register_init_function();
	init_ok &= __skadi_pipe_alloc_init_register_init_function();
	init_ok &= __skadi_pipe_put_register_init_function();
	init_ok &= __skadi_pipe_get_register_init_function();
	init_ok &= __skadi_pipe_read_avail_register_init_function();
	init_ok &= __skadi_pipe_write_avail_register_init_function();
	init_ok &= __skadi_pipe_flush_register_init_function();
	init_ok &= __skadi_pipe_buffer_flush_register_init_function();
	
    return init_ok == true ? 0 : -ENOMEM;
}

SYS_INIT(pipe_init_trampolines, PRE_KERNEL_1, CONFIG_LOADER_SKADI_TRAMPOLINE_INIT_PRIO);
